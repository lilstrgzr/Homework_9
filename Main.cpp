...
int main() {
    setlocale(0, "Russian");
    Hospital hospital({ " Curtis Jackson", "Jeffery Lamar Williams", "Nayvadius DeMun Cash", "Austin Richard Post"}, 8);

    hospital.put(" Kendrick Lamar Duckworth");
    hospital.put("Jarad Anthony Higgins");
    ...
    std::cout << hospital.find("Jeffery Lamar Williams") << std::endl;
